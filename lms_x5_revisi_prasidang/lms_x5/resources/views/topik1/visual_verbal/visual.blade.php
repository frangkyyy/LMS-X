    ...
    <div class="container">
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                @if ($course && $course->id)
                    @php
                        $visualFiles = \App\Models\MDLFiles::where('course_id', $course->id)
                ...
                @if ($visualFiles->count() > 0)
                    @foreach ($visualFiles as $file)
                        @if ($file->type === 'visual-link')
                                ...
                                <div class="card mt-4">
                                    <div class="card-body">
                                        ...
                                        @if (!empty($file->description))
                                            <p class="text-start fw-bold">{{ $file->description }}</p>
                                        @endif
                                        <embed src="{{ asset($file->file_path) }}" type="application/pdf" width="100%" height="600px">
                                    </div>
                                </div>
                            @endif
                    @endforeach
