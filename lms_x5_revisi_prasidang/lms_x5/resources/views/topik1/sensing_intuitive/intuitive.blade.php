    ...
    <div class="container">
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                @if ($course && $course->id)
                    @php
                        $intuitiveFiles = \App\Models\MDLFiles::where('course_id', $course->id)
                ...
                @if ($intuitiveFiles->count() > 0)
                    @foreach ($intuitiveFiles as $file)
                        @if ($file->type === 'intuitive-link')
                        ...
                        @elseif ($file->type === 'intuitive-pdf')
                            <div class="d-flex flex-column mb-3">
                                <div class="d-flex align-items-center mb-2">
