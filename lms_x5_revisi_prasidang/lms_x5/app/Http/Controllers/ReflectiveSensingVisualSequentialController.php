...
class ReflectiveSensingVisualSequentialController extends Controller
{
    /**
    ...
    public function index($course_id, $topik, $section_id)
    {
        ...
        return view('layouts.v_template', [
            ...
            'content' => "learning_styles_combined.topik$topik.reflective_sensing_visual_sequential.index",
            'course' => $course,
            'section' => $section,
            'scores'     => $scores,
