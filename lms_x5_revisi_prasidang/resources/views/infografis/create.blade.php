                    ...
                    <div class="card shadow-sm border-0 rounded-lg">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('infografis.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                                ...
                                <div class="row g-4">
                                    <div class="col-12">
                                        <label for="file_upload" class="form-label font-weight-medium" style="font-family: 'Poppins', sans-serif; color: #3F4254;">Upload Gambar/Video Infografis (Khusus Visual)</label>
                                    ...
                                    <div class="col-12 mt-4">
                                        <button type="submit" class="btn btn-primary px-4 py-2 font-weight-medium" style="font-family: 'Poppins', sans-serif; background-color: #3699FF; border-color: #3699FF;">Buat Infografis</button>
                                    </div>
                                </div>
                            </form>
                        </div>
