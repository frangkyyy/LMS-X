            ...
            <div class="modal-body">
                <form id="formUser" name="formUser">
                    <div class="form-group mb-3">
                        <label for="id" class="form-label">NRP/NIP/NIK</label>
                        <input type="text" name="id" class="form-control" id="id" placeholder="Enter NRP/NIP/NIK">
                    </div>
                    <div class="form-group mb-3">
...
<div class="modal fade" id="view-user-modal" tabindex="-1" role="dialog" aria-labelledby="viewUserLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3"><strong>NRP/NIP/NIK:</strong> <span id="view-id"></span></div>
        ...
        $(document).ready(function () {
            ...
            var table = $('#tableUser').DataTable({
                ...
                columns: [
                    ...
                    { data: 'id', name: 'id' }, // Kolom untuk NRP/NIP/NIK
                    { data: 'name', name: 'name' },
            ...
            $('#createNewUser').click(function () {
                ...
                $('#id').prop('disabled', false); // Aktifkan input id untuk user baru
            ...
            $('body').on('click', '.editUser', function () {
                ...
                $.get("{{ route('users.edit', ':id') }}".replace(':id', user_id), function (data) {
                    ...
                    $('#modal-user').modal('show');
                    $('#user_id').val(data.id);
                    $('#id').val(data.id).prop('disabled', true); // Nonaktifkan input id saat edit
                    $('#name').val(data.name);
            ...
            $('#saveBtn').click(function (e) {
                ...
                if (!user_id) {
                    if (!id) {
                        swal_error('NRP/NIP/NIK harus diisi!');
                        $(this).html('Save changes');
                        return;
                    }
                    if (!password || password.length < 5) {
                        swal_error('Password harus minimal 5 karakter untuk user baru!');
                        $(this).html('Save changes');
                        return;
                    }
                }
                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        ...
                        if (xhr.status === 422 && xhr.responseJSON.message === 'The id has already been taken.') {
                            errorMsg = 'NRP/NIP/NIK sudah digunakan!';
                        }
                        swal_error(errorMsg);
