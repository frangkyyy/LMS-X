<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="container">
        <!-- LMS X Introduction Image -->
        <div class="card mt-3">
            <div class="card-body text-center">
                <img src="{{ asset('iot/lms_x.png') }}" class="img-fluid w-100" style="height: auto; max-height: 457px; object-fit: cover;" alt="Pengenalan IoT">
            </div>
        </div>
