    ...
    <div class="container">
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                @if ($course && $course->id)
                    @php
                        $sensingFiles = \App\Models\MDLFiles::where('course_id', $course->id)
                ...
                @if ($sensingFiles->count() > 0)
                    @foreach ($sensingFiles as $file)
                        @if ($file->type === 'sensing-link')
