...
class ReflectiveIntuitiveVisualGlobalController extends Controller
{
    /**
    ...
    public function index($course_id, $topik, $section_id)
    {
        ...
        return view('layouts.v_template', [
            ...
            'content' => "learning_styles_combined.topik$topik.reflective_intuitive_visual_global.index",
            'course' => $course,
            'section' => $section,
