<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="container">
        ...
        {{-- Materi Utama --}}
        <div class="card mt-3" id="materi-utama">
            <div class="card-body">
                ...
                @endif
                    ...
                    {{-- === Url Files Reflective === --}}
                    @if ($url_files_reflective->count() > 0)
                        @foreach ($url_files_reflective as $url)
                            <div class="mb-4 d-flex flex-column mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <i class="fas fa-link text-primary mr-3"></i>
                                    <a href="{{ $url->url_link }}" target="_blank" class="btn btn-outline-info mt-2">
                                        🔗 {{ $url->name }}
                                    </a>
                                </div>
