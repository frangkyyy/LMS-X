    ...
    <div class="container">
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                @if ($course && $course->id)
                    @php
                        $verbalFiles = \App\Models\MDLFiles::where('course_id', $course->id)
                ...
                @if ($verbalFiles->count() > 0)
                    @foreach ($verbalFiles as $file)
                        @if ($file->type === 'verbal-link')
