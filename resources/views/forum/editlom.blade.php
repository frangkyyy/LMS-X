...
@section('content')
    ...
    <div class="container mt-4">
        <h2>Editing Forum for {{ $subTopic->title }}</h2>
        <form method="POST" action="{{ route('forums.update', $forum->id) }}" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $forum->name) }}" required>
                    ...
                    @php
                        ...
                        $selectedOption = $forum->dimension_option_id ?? null;
                    @endphp
